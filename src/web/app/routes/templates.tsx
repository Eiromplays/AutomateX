    ...
    <div className="max-w-4xl space-y-4">
      <div>
        ...
        <p className="text-sm text-zinc-500">
          Start from a ready-made workflow — you&apos;ll review and tweak it (URLs, connections, rooms) before creating.
        </p>
      </div>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        {templates.map((template) => (
          <div key={template.id} className="flex flex-col rounded-lg border border-zinc-800 bg-zinc-900/40 p-4">
            ...
            <button
              type="button"
              onClick={() => navigate("/workflows/new", { state: { importDoc: template.doc } })}
